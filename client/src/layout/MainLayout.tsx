...
export default function MainLayout() {
  ...
  useEffect(() => {
    ...
    map.on("load", () => {
      ...
      console.log("Container:", map.getContainer().getBoundingClientRect());
    });
  ...
  useEffect(() => {
    ...
    const fetchRoute = async () => {
      try {
        ...
        drawRoute(coordinates, route.distance, route.duration);
      } catch (error) {
    ...
    fetchRoute();
  }, [location, destination, drawRoute]);
      ...
      >
        <div className="p-5 md:p-6">
          ...
          >
            ...
            {!createRide.isPending && destination && <Navigation size={16} />}
          </motion.button>
          ...
          {results.map((result) => (
            <button
              ...
              onClick={() => {
                ...
                onSelect(result as Destination);
              }}
              className="
                  flex
                  w-full
